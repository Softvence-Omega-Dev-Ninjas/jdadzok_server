...
import { IsString, IsOptional, IsBoolean, IsEnum, IsDate, IsInt, IsDateString } from 'class-validator';
import { Type } from 'class-transformer';
import { CommunityType, CapLevel, CommunityRole } from '@prisma/client';
...
export class CommunityProfileDto {
  ...
  @ApiProperty({
    ...
    example: 'A community of technology enthusiasts who share knowledge, organize events, and collaborate on projects.',
    required: false,
  })
  @IsOptional()
  bio?: string;
...
export class CommunityAboutDto {
  ...
  @ApiProperty({
    ...
    example: 'To promote innovation and collaboration in the field of renewable energy.',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class CommunitiesMembershipDto {
  ...
  @ApiProperty({ description: 'Role of the user in the community', enum: CommunityRole })
...
export class CreateCommunityDto {
  ...
  @ApiProperty({ description: 'Type of community', example: CommunityType.PUBLIC })
  @IsEnum(CommunityType)
  communityType: CommunityType;

  @ApiProperty({ description: 'Community profile info', type: () => CommunityProfileDto, required: false })
  @IsOptional()
  profile?: CommunityProfileDto;

  @ApiProperty({ description: 'Extended community info', type: () => CommunityAboutDto, required: false })
  @IsOptional()
...
// update dtos
export class UpdateCommunityDto extends PartialType(OmitType(CreateCommunityDto, ['foundationDate'] as const)) {}

export class UpdateCommunitiesMembershipDto extends PartialType(CommunitiesMembershipDto){}

export class UpdateCommunityAboutDto extends PartialType(CommunityAboutDto){}

export class UpdateCommunityProfileDto extends PartialType(CommunityProfileDto){}
