...
export class SimpleBaseQueryDto {
    ...
    @ApiProperty({
        required: false,
        description: 'Fields to search within, e.g., "title", "content". Must be a JSON array string.',
        isArray: true,
    ...
    @ApiProperty({
        required: false,
        description: 'Nested includes as a JSON string. e.g., \'{"author": true, "tags": true}\'',
    ...
    @ApiProperty({
        required: false,
        description: 'Fields to select as a JSON string. e.g., \'{"id": true, "title": true, "author": { "select": { "name": true }}}\'',
        example: '{"id": true, "title": true, "author": { "select": { "name": true }}}',
    })
    @IsOptional()
    @IsJSON()
    select?: string;
